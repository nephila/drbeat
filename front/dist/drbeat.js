...
(function() {
  var DrBeatAdmin, DrBeatDirective, debounce, drBeatInfo, initDrBeatPlugin, module,
  ...
  DrBeatAdmin = (function() {
      ...
      this.scope.$on("project:loaded", (function(_this) {
        return function() {
          ...
          promise.then(function(drbeats) {
            ...
            _this.decorateDrBeat(_this.scope.drbeat);
    ...
    DrBeatAdmin.prototype.decorateDrBeat = function(drbeat) {
      var drbeat_en_priorities, i, len, priority, ref, ref1, results;
      drbeat.priorities = this.scope.project.priorities;
